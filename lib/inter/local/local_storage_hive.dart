...
class LocalStorageHive implements LocalStorage {
  ...
  Future<void> init() async {
    ...
    if (!Hive.isBoxOpen(LocalStoragePath.accessToken.name)) {
      await Hive.openBox(LocalStoragePath.accessToken.name);
    }

    if (!Hive.isBoxOpen(LocalStoragePath.refreshToken.name)) {
      await Hive.openBox(LocalStoragePath.refreshToken.name);
    }
  }
